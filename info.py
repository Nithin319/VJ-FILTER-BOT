...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001973315956'))
...
URL = "https://jishan202-of3u.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://jishan202-of3u.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://jishan202-of3u.onrender.com/".format(FQDN)
else:
    URL = "https://jishan202-of3u.onrender.com/".format(FQDN)
